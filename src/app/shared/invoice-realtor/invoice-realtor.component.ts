...
@Component({
  selector: 'app-invoice-realtor',
  templateUrl: './invoice-realtor.component.html',
  styleUrls: ['./invoice-realtor.component.css']
})
export class InvoiceRealtorComponent implements OnInit, OnChanges  {
    ...
    ngOnChanges(){
      ...
      if(this.searchTerm != ''){
          ...
          this.invoiceService.loadRealtorInvoices(localStorage.getItem('FRLS-D').toString()).subscribe(data=>{
              if(data.status == 200){
